...
- Window targeting defaults to title-matching hints generated by the relay. Common sources include workspace name/path, Remote SSH/WSL remote identity, workspace files, and active or visible editor paths.
